...
function ValueSlides() {
  ...
  return (
    <>
      <div ref={featureSliderRef} className="feature-slides-container hide-on-mobile" name="why-us">
        ...
        <div ref={featureSlidesRightRef} className="feature-slides-right hide-on-mobile">
          <RenderImages activeFeatureIndex={activeFeatureIndex} />
        </div>
      </div>

      {/* Another display on mobile*/}
      <div name="why-us" className="feature-slides-container-mobile hide-on-desktop">
